...
@RestController
@RequestMapping("/api/autopilots")
public class AutopilotController {
    private JdbcAutopilotDao autopilotDao;
    ...
    public AutopilotController(){
        ...
        autopilotDao = new JdbcAutopilotDao(dataSource);
    }


    @RequestMapping(path = "", method = RequestMethod.GET)
    List<Autopilot> allAutopilots(){
        return autopilotDao.getAllAutopilotOptions();
    }
}
